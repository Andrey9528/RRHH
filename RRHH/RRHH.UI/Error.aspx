...
<body>
    ...
    <div id="VistaEmpleado" visible="false" runat="server">
  ...
  <div class="modal fade" id="vaca" role="dialog">
    ...
    <asp:TextBox ID="txtfechafinal" Width="280" TextMode="Date" CssClass="form-control" runat="server" ></asp:TextBox>
        ...
        <div class="modal-footer">
          ...
          <asp:Button ID="btnvaca" runat="server" Text="Insertar" CssClass="btn btn-success"   />
                          ...
                          <div class="modal-content" style="margin-top:100px;">
                             ...
                             <div class="form-group">
                                 ...
                                 <p style="margin-top:10px;">  
                                     ...
                                     <asp:Button ID= "btnConfirmarEmpleado" runat="server" Text="Confirmar" CssClass="btn btn-warning" /> </p>
                                 <br/> <br/>
...
<%--                                 <asp:CheckBox ID="ChkVerContraseña2" runat="server" />--%>
                             ...
                             <div class="form-group">
                              ...
                              <div class="modal-footer">
                                  ...
                                  <asp:Button ID="btnCambiarEmpleado" CssClass ="btn btn-success" Enabled="false"  runat="server"  Text="Cambiar" />
                                  <asp:Button ID="btnSalirEmpleado" data-dismiss="modal" CssClass="btn btn-danger"   runat="server"  Text="Salir" />
    ...
    <script type="text/javascript">
        ...
        <div id="vistaJefe" visible="false" runat="server">
    <h1>HOLA SOY JEFE</h1>
