   ...
   <br />
     ...
     <br />
      ...
      <div class="form-inline  " style="margin-top:-25px;">
          ...
          <asp:RadioButton ID="RB_personalizada" Autopostback="true" runat="server" GroupName="Seleccion"   />
       <asp:Label ID="Label2" runat="server" Text="Busqueda Personalizada"></asp:Label>
      
       <asp:RadioButton ID="RB_busquedageneral" Autopostback="true" Checked="true" runat="server" GroupName="Seleccion"  />
       ...
       &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
        ...
        <asp:Button ID="Btnbusca"  CssClass="btn btn-primary" runat="server" Text="Buscar" />
        &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
        <asp:Label ID="lblExportar" runat="server" Text="Exportar:"></asp:Label>
   
           
        <asp:Button ID="btnexportar" CssClass="btn btn-danger"   runat="server" Text="PDF" />
        ...
        <asp:GridView ID="gvdatos" runat="server" AutoGenerateColumns = False   CssClass="table table-responsive table-bordered " CellPadding="4" ForeColor="#333333" GridLines="None" Width="1030px">
            ...
            <SortedDescendingHeaderStyle BackColor="#4870BE" />
             <Columns runat="server" >         
                <asp:BoundField  DataField = "IdIncapacidad" runat="server" HeaderText = "N. Incapacidad" DataFormatString="asdasdsad" />
                ...
                <asp:BoundField  DataField = "asdasdas" runat="server" HeaderText = "Doctor" />
                <%--<asp:BoundField  DataField = "Estado" runat="server" HeaderText = "Estado" />
    --%>
             </Columns>
        </asp:GridView>
    </div>
    <asp:Button ID="btnregresar"  runat="server" CssClass="btn btn-success" Text="Regresar" /> 
