...
<div class="alert alert-success" visible="false"  id="mensaje" runat="server">
  ...
  <asp:Label ID="lbICedula" runat="server" Text="Cédula: "></asp:Label>
    ...
    <asp:Button ID="btnsBuscar" runat="server" Text="Buscar" CssClass="btn btn-primary"  />
 ...
 <asp:DropDownList ID="DDLid_incapacidad" CssClass="form-control"  runat="server"></asp:DropDownList>
    <br />
        <asp:Button ID="btnBuscarIncapacidad" CssClass="btn btn-success" runat="server" Text="Mostrar datos" />
      ...
      <asp:TextBox CssClass="form-control"  ID="txtfechainicio" runat="server"></asp:TextBox>
           ...
           <div class="col-sm-4">
                  <div class="form-inline">
                   ...
                   <asp:TextBox CssClass="form-control"  ID="txtfechafinalizacion" runat="server"></asp:TextBox>
