<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaVacacionesAdmin.aspx.cs" Inherits="RRHH.UI.ConsultaVacacionesAdmin" %>
   ...
   <br />
    <br />
      ...
      <div class="form-inline" style="margin-top:-25px;">
       ...
       <asp:RadioButton ID="RB_personalizada" Autopostback="true" runat="server" GroupName="Seleccion" OnCheckedChanged="RB_personalizada_CheckedChanged" OnInit="RB_personalizada_Init" />
